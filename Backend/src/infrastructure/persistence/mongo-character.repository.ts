...
export class MongoCharacterRepository implements ICharacterRepository {
  ...
  async create(character: Character): Promise<Character> {
    const created = new this.characterModel({
      ...
      sorcererMetamagic: character.sorcererMetamagic,
      ...
      magicInitiateClass: character.magicInitiateClass,
      magicInitiateAbility: character.magicInitiateAbility,
      magicInitiateCantrips: character.magicInitiateCantrips,
      magicInitiateSpell: character.magicInitiateSpell,
  ...
  private toDomain(doc: CharacterDocument): Character {
    return {
      ...
      sorcererMetamagic: doc.sorcererMetamagic,
      ...
      magicInitiateClass: doc.magicInitiateClass,
      magicInitiateAbility: doc.magicInitiateAbility,
      magicInitiateCantrips: doc.magicInitiateCantrips,
      magicInitiateSpell: doc.magicInitiateSpell,
      heroicInspiration: doc.heroicInspiration,
      history: doc.history,
